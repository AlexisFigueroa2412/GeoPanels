...
import geopanels.Empresas;
import geopanels.PrimerEmpresa;
 ...
 */
public class ClaseImagen_Empresa {
    ...
    public String GuardarImagen(JLabel lbl){
        String ruta = null;
        try{
            ImageIcon icon = (ImageIcon) Empresas.lblImagen.getIcon();
    ...
    public String GuardarImagenPrimero(JLabel lbl2){
        String ruta = null;
        try{
            ImageIcon icon = (ImageIcon) PrimerEmpresa.lblImagen.getIcon();
            BufferedImage image = new BufferedImage(icon.getIconWidth(),
            icon.getIconHeight(), BufferedImage.TYPE_INT_RGB);
            Graphics2D g2 = image.createGraphics();
            g2.drawImage(icon.getImage(), 0, 0, icon.getImageObserver());
