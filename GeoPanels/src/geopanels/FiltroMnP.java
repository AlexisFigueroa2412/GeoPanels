 ...
 * @author jalex
 */
public class FiltroMnP extends javax.swing.JFrame {

    ClaseFacturaMan fac= new ClaseFacturaMan();
    public static ResultSet retorno;
    /**
     * Creates new form FiltroMnP
     */
    public FiltroMnP() {
        initComponents();
    ...
    public void Llenar_Tabla(){
        ...
        cl.setRowCount(0);
        retorno = fac.Mostrar_MantenimientoP();
        try
        {
            while(retorno.next())
            {
    ...
    public void Llenar_TablaCliente(){
        DefaultTableModel cl = (DefaultTableModel) Tabla.getModel();
        cl.setRowCount(0);
        retorno = fac.Filtrar_MantenimientoClienteP();
        try
        {
            while(retorno.next())
            {
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if (!txtId.getText().isEmpty() && !txtCosto.getText().isEmpty()) {
            FacturaMan.txtMp.setText(this.txtId.getText());
            FacturaMan.txtSubP.setText(this.txtCosto.getText());
            this.dispose();
        }
        else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FiltroMnP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
