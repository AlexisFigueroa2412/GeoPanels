...
import static geopanels.HistorialPago.res;
 ...
 * @author jalex
 */
public class Historial_Pago extends javax.swing.JPanel {

    /**
     * Creates new form Historial_Pago
     */
    ...
    public void Consultar()
    {
        ...
        DefaultTableModel modelo = (DefaultTableModel) tabla_resultado.getModel();
        modelo.setRowCount(0);
        res = Clases.Conexion.Consulta("Select*From Factura_producto where fecha = '" +fecha+ "'");
        try
        {
            while(res.next())
            {
