 ...
 * @author jalex
 */
public class FiltroFacturaM extends javax.swing.JFrame {
    ClaseFactura fac= new ClaseFactura();
    public static ResultSet retorno;
    /**
     * Creates new form FiltroFacturaM
     */
    public FiltroFacturaM() {
        initComponents();
        Llenar_Tabla();
    ...
    public void Filtrar_Mantenimiento(){
        ...
        retorno = fac.Filtrar_Mantenimiento();
        try
        {
            while(retorno.next())
            {
...
//        Pago.txtGenerado.setText(txtFactura.getText());
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        // TODO add your handling code here:
        Pago.txtGenerado.setText(this.txtFactura.getText());
        Pago.jTextField2.setText(this.txtTotal.getText());
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FiltroFacturaM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FiltroFacturaM().setVisible(true);
            }
        });
    }
