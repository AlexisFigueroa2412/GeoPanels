 ...
 * @author jalex
 */
public class FiltroFacturaMP extends javax.swing.JFrame {
    ClaseFactura fac= new ClaseFactura();
    public static ResultSet retorno;
    /**
     * Creates new form FiltroFacturaMP
     */
    public FiltroFacturaMP() {
        initComponents();
    ...
    private void initComponents() {
        ...
        Tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "N°", "Fecha", "N° Tipo Mantenimiento", "Total"
            }
        ) {
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addComponent(idTipo, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
    ...
    public void pasarDatosFila(){
        ...
        idTipo.setText(nombre);
        txtFactura.setText(identificador);
        
    }
    public void Filtrar_Mantenimiento(){
        DefaultTableModel cl = (DefaultTableModel) TablaF.getModel();
        cl.setRowCount(0);       
        
        retorno = fac.Filtrar_MantenimientoP();
        try
        {
            while(retorno.next())
            {
    ...
    private void TablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaMouseClicked
        ...
        pasarDatosFila();
        fac.setIdCarro(Integer.parseInt(idTipo.getText()));
//        Pago.txtProgramado.setText(txtFactura.getText());
        Filtrar_Mantenimiento();
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        // TODO add your handling code here:
        Pago.txtProgramado.setText(this.txtFactura.getText());
        Pago.jTextField3.setText(this.txtTotal.getText());
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FiltroFacturaMP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FiltroFacturaMP().setVisible(true);
            }
        });
    }
